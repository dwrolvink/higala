  ...
  <b-collapse class="card">
    <div slot="trigger" slot-scope="props" class="card-header">
      <p class="card-header-title">
        ...
        <span v-show="admin" class="ml2">
          <b-tooltip label="User is an admin" position="is-bottom" type="is-dark" square animated>
            <b-icon icon="star-circle" size="is-small"></b-icon>
          </b-tooltip>
        </span>
      </p>
    ...
    <div class="card-content">
      <div class="content">
        ...
        <ul>
          <li v-show="currentuser.first_name && currentuser.last_name">
            <b-icon icon="alphabetical" size="is-small"></b-icon>
    ...
    <footer class="card-footer">
      <a class="card-footer-item">
        <button class="button is-danger is-fullwidth" @click="goToProfile">Profile</button>
        <b-tooltip position="is-bottom" label="Logout" animated square type="is-dark">
...
export default {
  ...
  methods: {
    ...
    confirmLogout() {
      this.$dialog.confirm({
        title: "Logging out",
        message: "Are you sure you want to <b>log out</b> of your account?",
        confirmText: "Log out",
        type: "is-warning",
        hasIcon: true,
        icon: "exit-to-app",
